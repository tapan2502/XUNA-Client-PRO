    ...
    <div className="flex flex-col gap-6 h-full p-6 max-w-7xl mx-auto w-full text-foreground">
      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <span className="px-2 py-0.5 text-xs font-medium bg-[#65a30d]/10 text-[#65a30d] rounded">
            Beta
          </span>
        </div>
      ...
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="bg-card border border-border rounded-xl p-12 max-w-md w-full text-center">
          <div className="w-16 h-16 rounded-xl bg-[#ecfccb] text-[#65a30d] dark:bg-[#365314] dark:text-[#ecfccb] flex items-center justify-center mx-auto mb-4">
            <Wrench size={32} />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button className="px-4 py-2 text-sm font-medium text-foreground bg-background border border-[#65a30d] rounded-lg hover:bg-[#65a30d]/10 transition-colors">
              Connected to GHL
            </button>
